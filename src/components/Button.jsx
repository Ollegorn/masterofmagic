function Button({ className, children = "Button", onClick, variant = "primary" }) {
  return (
    <>
      <button
        className={ `${
          variant === "cta"
            ? `inline-flex items-center justify-center rounded border-2 border-solid border-primary04-500 from-primary04-400 to-primary04-100 px-4 py-2 font-body text-base font-semibold text-primary04-500 transition-all hover:-translate-y-1 hover:border-none hover:bg-gradient-to-r hover:text-primary04-900 md:px-6 md:py-3 lg:px-8 lg:py-4 lg:text-lg xl:text-xl`
            : variant === "secondary"
